...
@Component
@ConfigurationProperties("servermlengine")
//@Configuration("servermlengine")
public class MLEngineProperties {
	...
	@Override
	public String toString() {
		return "MLEngineProperties [cluster=" + cluster + ", appPath=" + appPath + "]";
	}
